...
function cadastrarDespesa() {
    ...
    if(despesa.validarDados()) { 
       ...
       document.getElementById('textotitulo').innerHTML = 'Resgistro Gravado!'
       document.getElementById('mensagem').innerHTML = 'O Registro foi gravado com sucesso!'
       ...
       document.getElementById('textotitulo').innerHTML = 'Dados Inválidos'
